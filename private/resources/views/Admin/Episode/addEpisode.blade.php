    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1" style="padding-top:40px;">
        ...
        <div class="box-body">
          <form method="POST" enctype="multipart/form-data" id="episode-add" action="{{ url('admin/episode/build') }}" >
            <!-- text input -->
            ...
            <div class="col-md-6 col-md-offset-3">
              <button type="submit" class="btn btn-primary btn-block">Add New Episode</button>
            </div>
